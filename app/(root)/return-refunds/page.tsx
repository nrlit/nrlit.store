    ...
    <div className="container mx-auto py-8">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          ...
          refunds on purchases once the product has been delivered. However, we
          value your satisfaction and will consider refunds on a case-by-case
          basis.
        </p>
        ...
        <ul>
          ...
          <li>
            The product is non-functional or doesn&apos;t perform as advertised.
          </li>
          <li>
        ...
        <p>
          ...
          method of payment. The time it takes for the refund to appear in your
          account can vary depending on your payment provider.
        </p>

        <h2>5. Exceptions</h2>
        <p>
          We reserve the right to refuse refunds if we suspect fraud or abuse of
          our refund policy.
        </p>

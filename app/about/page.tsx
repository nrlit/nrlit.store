      ...
      <div className="container mx-auto py-8">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p>
            ...
            cutting-edge digital solutions that enhance productivity, foster
            learning, and unleash creativity.
          </p>
          <p>
            Founded in 2023, we have quickly grown to become a trusted source
            for digital products, serving customers worldwide with our curated
            selection of software, courses, and creative tools.
          </p>
          <h2 className="text-2xl font-semibold mt-8 mb-4">Our Values</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Quality: We only offer products that meet our high standards.
            </li>
            <li>
